...
Here we have a set of instructions and guidelines to reduce misunderstandings and make the process of contributing to `vite-helper` as smooth as possible.
...
As a user of `vite-helper`, you're the perfect candidate to help us improve our documentation!
...
The [`question`](https://github.com/tl-lucasestevam/vite-helper/labels/question) label are a good place to find ongoing discussions.

### Code

You can use issue labels to discover issues you could help out with:

- [`bug` issues](https://github.com/tl-lucasestevam/vite-helper/labels/bug)
  are known bugs we'd like to fix;
- [`enhancement` issues](https://github.com/tl-lucasestevam/vite-helper/labels/enhancement)
